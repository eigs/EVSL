	...
	integer *lwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    integer iindbl;
    logical valeig;
    extern /* Subroutine */ int dlarrc_(const char *, integer *, doublereal *,
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *,
	     integer *, integer *, integer *), dlarre_(const char *,
    ...
    extern /* Subroutine */ int dlarrr_(integer *, doublereal *, doublereal *,
	    ...
	    integer *, integer *), dlasrt_(const char *, integer *, doublereal *,
	    integer *);
    doublereal thresh;
