...
int  SetupASIGMABSolDirect(csrMat *A, csrMat *BB, int num, int l, EVSL_Complex *zk, void **data);
...
void EVSLFORT(setup_asigmabsol_direct,SETUP_ASIGMABSOL_DIRECT)(uintptr_t *Af90, int *flagB, uintptr_t *Bf90, uintptr_t *ratf90, int *l, uintptr_t *solshiftf90);
